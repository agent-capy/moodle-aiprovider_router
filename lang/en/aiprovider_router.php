...
$string['eligibility:unknown'] = 'This policy also holds conditions this version does not understand ({$a}), which are being ignored. Since every condition has to hold, ignoring one can only admit people a newer version would have refused. Saving this form will remove them.';
