...
$string['condition:describe:promptlength:gte'] = 'プロンプト長（推定）: {$a} トークン以上';
$string['condition:describe:promptlength:lte'] = 'プロンプト長（推定）: {$a} トークン以下';
...
$string['condition:promptlength'] = 'プロンプト長（推定）';
$string['condition:promptlength:gte'] = '以上';
$string['condition:promptlength:lte'] = '以下';
$string['condition:promptlength_help'] = '比較する値は実測値ではなく推定値です。ルールを判定する時点では、まだどこにも送信していません。推定は文字数とサイトに設定された係数から求めるため、実際にプロバイダが課金するトークン数とは差が出ます。想定しているプロンプトの推定値は、ルールのテスト画面で確認できます。';
...
$string['ruletest:prompt_help'] = '使うのは長さだけです。プロンプト長条件が比較する推定トークン数を求めるために使います。本文はどこにも送信されません。';
$string['ruletest:request'] = 'テストする要求';
$string['ruletest:result'] = '各ルールの判定結果';
$string['ruletest:run'] = 'テストする';
$string['ruletest:tokens'] = 'プロンプト長（推定）';
$string['ruletest:tokens:value'] = '約 {$a->tokens} トークン（{$a->characters} 文字。うち {$a->cjk} 文字を1トークンあたり {$a->cjkratio} 文字、{$a->other} 文字を {$a->otherratio} 文字として計算）。これは推定値で、プロバイダが実際に課金する値とは差が出ます。';
