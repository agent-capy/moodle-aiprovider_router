...
namespace aiprovider_router\task;
...
class summarise_usage extends \core\task\scheduled_task {
    ...
    public function get_name(): string {
        return get_string('task:summariseusage', 'aiprovider_router');
    }
    ...
    public function execute(): void {
        ...
        mtrace(get_string('task:summariseusage:done', 'aiprovider_router', (object) $result));
    }
}
