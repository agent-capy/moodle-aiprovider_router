...
class singleinstance extends base {
    ...
    protected function check_router(): result {
        ...
        if (count($routers) < 2) {
            return new result(result::OK, get_string('check:singleinstance:ok', 'aiprovider_router'));
        }
        ...
        return new result(
            result::ERROR,
            get_string('check:singleinstance:duplicates', 'aiprovider_router', count($routers)),
