...
class routerfirst extends base {
    ...
    protected function check_router(): result {
        ...
        $details = get_string('check:routerfirst:details', 'aiprovider_router', [
        ...
        if ($router->get_mode() === provider::MODE_COEXIST) {
            return new result(
                result::INFO,
                get_string('check:routerfirst:coexist', 'aiprovider_router'),
                $details,
            );
        }
        ...
        return new result(
            result::ERROR,
            get_string('check:routerfirst:notfirst', 'aiprovider_router'),
            $details,
        );
    }
}
