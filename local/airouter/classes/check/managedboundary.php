...
class managedboundary extends check {
    ...
    public function get_name(): string {
        return get_string('check:managedboundary', 'local_airouter');
    }
    ...
    public function get_result(): result {
        ...
        if (!$manager instanceof routing_manager) {
            return new result(
                result::ERROR,
                get_string('check:managedboundary:replaced', 'local_airouter'),
                get_string('check:managedboundary:details', 'local_airouter', [
                    'actions' => $names,
        ...
        return new result(result::OK, get_string('check:managedboundary:ok', 'local_airouter', $names));
    }
}
