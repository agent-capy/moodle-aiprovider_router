...
use local_airouter\condition\category as category_condition;
use local_airouter\condition\course as course_condition;
...
class rule_repository {
    ...
    public const CONDITION_TABLE = 'local_airouter_condition';
    ...
    protected function record_rule_count(): void {
        set_config('rulecount', $this->db->count_records(rule::TABLE), 'local_airouter');
    }
