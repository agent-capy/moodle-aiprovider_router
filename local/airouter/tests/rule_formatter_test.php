...
final class rule_formatter_test extends \advanced_testcase {
    ...
    public function test_a_rule_with_no_conditions_says_it_takes_everything(): void {
        ...
        $this->assertStringContainsString(
            get_string('rules:noconditions', 'local_airouter'),
            $output,
        );
    }
    ...
    public function test_a_prompt_length_condition_is_described_in_characters(): void {
        ...
        $this->assertStringContainsString(
            get_string('condition:describe:promptlength:gte', 'local_airouter', 2000),
            $output,
        );
    }
    ...
    public function test_a_rule_paid_for_with_a_brought_key_says_whose(): void {
        ...
        $this->assertStringContainsString(
            get_string('keysource:' . rule::KEYSOURCE_USER, 'local_airouter'),
            $output,
        );
    }
    ...
    public function test_a_disabled_rule_says_so(): void {
        ...
        $this->assertStringContainsString(get_string('rules:disabled', 'local_airouter'), $output);
    }
    ...
    public function test_a_rule_nothing_can_reach_says_so(): void {
        ...
        $this->assertStringContainsString(get_string('rules:unreachable', 'local_airouter'), $output);
    }
